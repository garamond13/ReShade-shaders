...
SamplerState ssLensOptics_s : register(s5);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = r1.zw ? cbComposites.VignetteBorder.xz : cbComposites.VignetteBorder.yw;
  r1.xy = r1.xy * r1.zw;
  r1.x = dot(r1.xy, r1.xy);
  r1.x = sqrt(r1.x);
  r1.x = cbComposites.VignetteFalloff * r1.x;
  r1.x = r1.x * r1.x + 1;
  r1.x = r1.x * r1.x;
  r1.x = rcp(r1.x);
  r1.x = 1 + -r1.x;
  r1.y = cbComposites.VignetteColor.w * VIGENETTE_STRENGTH * r1.x;
  r1.x = -cbComposites.VignetteColor.w * VIGENETTE_STRENGTH * r1.x + 1;
  r2.xyzw = compositeSourceTex.Sample(ssCompositeSource_s, r0.xy).xyzw;
  r3.yz = lensOpticsTex.Sample(ssLensOptics_s, r0.xy).yz;
  r1.xzw = r2.xyz * r1.xxx;
  o0.w = r2.w;
  r1.xyz = cbComposites.VignetteColor.xyz * r1.yyy + r1.xzw;
  ...
  r2.xy = CV_ScreenSize.zw + CV_ScreenSize.zw;
  r2.xy = r2.xy * cbComposites.ChromaShift + float2(1,1);
  r2.zw = v1.xy * CV_HPosScale.xy + float2(-0.5,-0.5);
  r2.xy = r2.zw * r2.xy + float2(0.5,0.5);
  r3.x = lensOpticsTex.Sample(ssLensOptics_s, r2.xy).x;
