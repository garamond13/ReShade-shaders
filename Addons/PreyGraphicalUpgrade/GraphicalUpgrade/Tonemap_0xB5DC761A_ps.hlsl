  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = r0.y * r0.x;
  r0.yz = CV_HPosScale.xy * v1.xy;
  r0.yzw = bloomTex.Sample(ssHdrLinearClamp_s, r0.yz).xyz * BLOOM_INTENSITY;
  r1.xy = (int2)v0.xy;
  r1.zw = float2(0,0);
  r1.xyz = hdrSourceTex.Load(r1.xyz).xyz;
  r0.yzw = -r1.xyz + r0.yzw;
  r2.xyz = saturate(HDRBloomColor.xyz);
  ...
  r2.xyz = r0.xyz * float3(0.879999995,0.879999995,0.879999995) + float3(0.300000012,0.300000012,0.300000012);
