  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = compositeSourceTex.Sample(ssCompositeSource_s, r2.xy).xyz;
  r2.xyz = compositeSourceTex.Sample(ssCompositeSource_s, r2.zw).xyz;
  r3.xyz = r3.xyz * r3.xyz;
  r1.xyz = r1.xyz * r1.xyz + r3.xyz;
  r1.xyz = r2.xyz * r2.xyz + r1.xyz;
  r2.xy = v1.xy * CV_HPosScale.xy + CV_ScreenSize.zw;
  r2.xyz = compositeSourceTex.Sample(ssCompositeSource_s, r2.xy).xyz;
  r1.xyz = r2.xyz * r2.xyz + r1.xyz;
  ...
  r2.xy = cbComposites.ChromaShift * CV_ScreenSize.zw;
