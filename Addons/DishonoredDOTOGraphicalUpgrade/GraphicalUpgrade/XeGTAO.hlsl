// XeGTAO addopted for Dishonored: Death of the Outsider.
//
...
void XeGTAO_MainPass(uint2 pixCoord, float2 localNoise, Texture2D sourceViewspaceDepth, SamplerState depthSampler, out float4 outWorkingAOTermAndPackedDepth)
{
	...
	// It should be divided by XE_GTAO_OCCLUSION_TERM_SCALE
	// and after denoise multiplied by XE_GTAO_OCCLUSION_TERM_SCALE,
