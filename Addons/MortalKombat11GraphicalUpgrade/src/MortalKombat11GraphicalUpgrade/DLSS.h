...
// Preconfigured for Mortal Kombat 11.
	...
	void create_feature(ID3D11DeviceContext* ctx, uint32_t width, uint32_t height, DLSS_PRESET preset)
	{
		...
		switch (preset) {
			...
			case DLSS_PRESET_K:
				...
				break;
			case DLSS_PRESET_L:
				dlss_hint_renderer_preset = NVSDK_NGX_DLSS_Hint_Render_Preset_L;
				break;
			case DLSS_PRESET_M:
				dlss_hint_renderer_preset = NVSDK_NGX_DLSS_Hint_Render_Preset_M;
				break;
		}
