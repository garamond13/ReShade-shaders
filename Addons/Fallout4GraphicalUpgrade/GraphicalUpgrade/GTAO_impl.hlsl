...
// It's the diffrent CB in linearize_and_downsample_depth_0x1D1E3148 and in ssao_main_0x0307C239.
...
#define NDC_TO_VIEW_MUL (cb0[0].xy * cb0[2].xy * float2(-1.0, 1.0)) // cb0[0].xy is NDC_TO_VIEW_MUL in ssao_main_0x0307C239, cb0[2].xy is RT dimensions (half of swapchain) in ssao_main_0x0307C239.
#define NDC_TO_VIEW_ADD (cb0[0].zw * float2(-1.0, 1.0)) // cb0[0].zw is NDC_TO_VIEW_ADD in ssao_main_0x0307C239
