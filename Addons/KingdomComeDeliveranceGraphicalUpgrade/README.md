...
- Copy **KingdomComeDeliveranceGraphicalUpgrade.addon64**, **nvngx_dlss.dll** and **GraphicalUpgrade** folder in the game folder where **KingdomCome.exe.exe** is (ReShade should be installed in the same folder).
